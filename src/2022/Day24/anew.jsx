  ...
  for (let currMove = 0; currMove < moveNr; currMove++) {
    ...
    if (!isPlayerMove) {
      ...
      if (position[0] === 0 && position[1] === 1) {
        if (
          !bustedMoves.includes(
            `${moves.length}:${position[0]},${position[1]}:${position[0] + 1},${
              position[1]
            }`
          ) &&
        ...
        if (
          position[0] >= 1 &&
          !bustedMoves.includes(
            `${moves.length}:${position[0]},${position[1]}:${position[0]},${
              position[1] + 1
            }`
          ) &&
          ...
          !bustedMoves.includes(
            `${moves.length}:${position[0]},${position[1]}:${position[0]},${position[1]}`
          ) &&
      ...
      if (isBusted) {
        ...
        let lastPos = moves[moves.length - 2].position;
        bustedMoves.push(
          `${moves.length - 1}:${lastPos[0]},${lastPos[1]}:${currentPos[0]},${
            currentPos[1]
          }`
        );
