...
export default () => {
  ...
  data.forEach((row) => {
    ...
    if (i === 3) {
      ...
      for (var j = 0; j < group[0].length; j++) {
        commonLetter =
          group[1].includes(group[0][j]) && group[2].includes(group[0][j])
            ? group[0][j]
            : null;
        if (commonLetter) break;
      }

      console.log(
        "\x1b[8m\x1b[40m\x1b[0m\x1b[7m%c          commonLetter    \x1b[8m\x1b[40m\x1b[0m%c Day3b.jsx 331 \n",
      ...
      console.log(
        "\x1b[8m\x1b[40m\x1b[0m\x1b[7m%c          value    \x1b[8m\x1b[40m\x1b[0m%c Day3b.jsx 505 \n",
        "color: white; background: black; font-weight: bold",
        "",
        value
      );
  ...
  //     commonLetter = partTwo.includes(partOne[i]) ? partOne[i] : null;
  //     if (commonLetter) break;
  //   }
